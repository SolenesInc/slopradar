...
```diff
+ 44.900 mass added to functions over CC 10 (complex in source.go, CC 12, 14 lines)
- 0.000 mass removed from functions over CC 10
± +1 clone pairs
```
...
| function | bucket | CC before → after | SLOC before → after | Δmass | note |
|---|---|---:|---:|---:|---|
...
```mermaid
xychart-beta
    title "Repository erosion by month"
